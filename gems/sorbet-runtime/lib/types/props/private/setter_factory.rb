...
module T::Props
  module Private
    module SetterFactory
      ...
      ValidateProc = T.type_alias {T.proc.params(instance: T.untyped, prop: Symbol, val: T.untyped).void}
      ...
      NOOP_VALIDATE = T.let( -> (instance, prop, val) {}, ValidateProc)
    end
  end
end
